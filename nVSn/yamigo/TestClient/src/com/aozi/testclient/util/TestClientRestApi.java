package com.aozi.testclient.util;
...
public class TestClientRestApi {
	...
	public void login(String email, String password,
		...
		JSONObject parameters = new JSONObjectBuilder().put("email", email)
				.put("password", password);
		mRestClient.post("login", parameters,
				new OnRequestComplete<JSONObject>() {
					@Override
	...
	public void signup(String email, String fullName, String password,
			final OnRequestComplete<Void> complete) {
		JSONObject parameters = new JSONObjectBuilder().put("email", email)
				.put("full_name", fullName).put("password", password);
		mRestClient.post("users", parameters,
				new OnRequestComplete<JSONObject>() {
					@Override
					public void onComplete(RestError error, JSONObject json) {
						complete.onComplete(error, null);
